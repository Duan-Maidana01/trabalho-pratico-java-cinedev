...
public class CineDev {
        ...
        do {
            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    cancelarIngresso(scanner); // ainda falta implementar
                    break;
                case 4:
                    exibirRelatorio(); // ainda falta implementar
                    break;
                case 5:
                    System.out.println("Encerrando o sistema. Até logo!");
                    break;
    ...
    public static void comprarIngresso(Scanner scanner) {
        ...
        if (validarPosicao(fileira, assento)) {
            ...
            System.out.println("️ Posição inválida! Digite fileira entre 1-10 e assento entre 1-20.");
        }
    }
}
